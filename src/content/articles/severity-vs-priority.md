...
«هذا الـ bug خطير ولا مستعجل؟» — سؤال بسيط بالشكل، بس أغلب المختبرين الجدد بيجاوبوا عليه بحقل واحد. والنتيجة إنّه العيوب تُرتّب غلط: عيب بشع بشاشة ما بيفتحها حدا بياخد وقت الفريق، وعيب صغير بشاشة الدفع بيضلّ مفتوح لآخر Sprint.
...
**قد إيش العيب مؤذي تقنياً لما يصير.** بتوصف الأثر على النظام: هل بيوقف وظيفة كاملة؟ بيخرّب بيانات؟ بيطيّح التطبيق؟ ولا مجرّد شكل مش مضبوط؟
...
القاعدة اللي بتثبّت الفرق: **Severity بتوصف العيب، Priority بتوصف قرارنا تجاهه.**
...
الحالتين المائلتين (عالية/منخفضة) هي اللي بتفرّق المختبر المحترف: هو مين بيعرف إنّ عيب «صغير» تقنياً ممكن يكون أخطر شي على العميل، والعكس.
...
هنا بالضبط ليش الحقلين لازم يكونوا منفصلين: لو عندك حقل واحد، هذا العيب إمّا بينزل بالترتيب (بحكم إنّه Minor) أو بتضطر تكذب وتكتب Severity أعلى من الحقيقة.
...
1. **تعبئة الحقلين بنفس القيمة دايماً.** إذا كل عيوبك Severity = Priority، فأحد الحقلين ما إله قيمة عندك — والمصفوفة فوق ما بتُستخدم.
2. **المختبر يرفع Severity مشان يستعجل الإصلاح.** هذا بيضيّع الثقة بأرقامك، ولمّا يصير عيب حقيقي Critical محدا بياخده بجدية. لو بدك تستعجل، الطريق الصح إنّك توضّح **الأثر على العمل** بوصف الـ [bug report](/articles/how-to-write-bug-report/) وتخلّي Priority قرار صاحب القرار.
3. **الخلط بين Priority و«إلحاح المستخدم».** عميل زعلان مش نفس شي إنّه العيب أولوية — الأولوية بتتحدّد بأثر مالي/تعاقدي/سُمعة، مش بنبرة الرسالة.
...
5. **إهمال العيوب Blocker.** إذا العيب مانع باقي الاختبار (مش مانع المستخدم بس)، لازم تقول هذا صريح بالتقرير — لأنّه بيوقف خطة الاختبار كلها، وهذا Priority عالية بغضّ النظر عن Severity.
...
- **بيخلّي القرار واضح**: تقرير الجودة قبل الإصدار بيصير جملة واحدة مفهومة: «ما ضلّ ولا عيب Critical مفتوح، وضلّ ثلاثة Minor بأولوية Low».
...
نعم، وهذا طبيعي — مثلاً عيب خطير بميزة رح تُشال من المنتج بالإصدار الجاي.
...
- اتعلّم تكتب العيب نفسه صح: [كيف تكتب Bug Report ما يرجعلك](/articles/how-to-write-bug-report/).
- افهم مسار العيب من فتحه لإغلاقه: [دورة حياة الـ Bug](/articles/defect-life-cycle/).
