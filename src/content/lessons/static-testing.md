...
tags:
  ...
  - Static Testing
summary:
  - الاختبار الساكن بيفحص المنتج بدون ما يشغّله — بيلاقي العيب نفسه مش العطل
  - 'أي مخرَج مقروء بينفحص: متطلبات، user stories، معايير قبول، تصميم، كود، خطط وحالات اختبار، عقود'
  - قيمته الحقيقية إنّه بيلاقي عيوب بدري وبأرخص كلفة — قبل ما يصير في كود أصلاً
...
relatedLessons: []
appUsed: ''
exerciseTitle: راجع user story وطلّع عيوب قبل ما ينكتب كود
exercise:
  - خذ user story حقيقية من شغلك (أو اكتب وحدة لميزة «نسيت كلمة المرور») مع معايير قبولها
  - 'راجعها كـ reviewer وسجّل كل ملاحظة بجدول: الموقع، الوصف، ونوع العيب (غموض، تناقض، نقص، غير قابل للاختبار)'
  ...
  - اكتب عيبين تتوقّع الاختبار الساكن يلاقيهم والاختبار الديناميكي ما بيلاقيهم — وليش
exerciseNote: ما في إجابة وحيدة صح — المهم كل ملاحظة تكون مربوطة بنوع عيب واضح، والملاحظات على المنتج مش على كاتبه.
solution:
  - 'أمثلة عيوب بالـ story: «النظام لازم يستجيب بسرعة» (غير قابل للاختبار)، رابط إعادة التعيين بدون مدة صلاحية (نقص)، وتناقض بين نص الرسالة ومعيار القبول (تناقض)'
  ...
  - 'عيوب بيلاقيها الساكن بس: تناقض بين متطلبين، متطلب ناقص ما إله حالة اختبار، وانحراف عن معيار كتابة — لأنّها ما بتظهر كعطل وقت التشغيل'
...
- بيلاقي **العيب نفسه** مباشرة، بينما الاختبار الديناميكي بيلاقي **العطل** وبعدين بتدوّر على سببه.
...
- حتى مخرجات الاختبار نفسها بتنراجع: حالة اختبار مكتوبة غلط عيب بحد ذاته.

## 3. ليش الاختبار الساكن مهم؟

- بيكشف العيوب بدري، ووقتها كلفة الإصلاح بتكون الأرخص.
- بيلاقي عيوب الاختبار الديناميكي ما بيلاقيها: تناقض بين متطلبين، متطلب ناقص، متطلب غير قابل للاختبار، انحراف عن المعايير، ومشاكل بالتتبّع والتغطية.
...
- الساكن بيلاقي عيوب مباشرة، الديناميكي بيلاقي أعطال وبتحتاج debugging لتوصل للعيب.
- الساكن بيقدر يلاقي عيوب مستحيل تكتشفها بالتشغيل (كود غير قابل للوصول مثلاً)، والديناميكي بيلاقي أشياء ما بتظهر بالقراءة (أداء تحت حمل، سلوك بيئة الإنتاج).
...
- **غير رسمية (Informal)**: بدون عملية موثّقة، الهدف اكتشاف سريع للعيوب — أرخصها وأكثرها استعمالاً.
...
- **Inspection**: الأكثر رسمية — أدوار محدّدة، قواعد دخول وخروج، ومقاييس؛ الهدف اكتشاف أكبر عدد عيوب وتحسين العملية.
