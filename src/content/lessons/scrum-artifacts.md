---
title: المخرجات الثلاثة — Scrum Artifacts
...
summary:
  ...
  - Definition of Done هي تعريف الجودة — أي شي ما بيحقّقها مش Done وما بيُعرض بالـ Sprint Review
prerequisites:
  - 'الدرس الرابع: الأحداث الخمسة — Scrum Events'
...
exercise:
  - 'افتح Backlog مشروعك: هل هو مرتّب بأولوية واضحة ولا Tickets بلا ترتيب؟'
  - اكتب Product Goal لمنتجك بجملة واحدة
  - خود آخر Sprint واكتب Sprint Goal + العناصر + الخطة — الثلاثة مع بعض
  ...
  - حدّد عنصر انتهى «شكلياً» بSprint سابق وهو ما بيحقّق الـ DoD، وشو صار فيه بعدين
exerciseNote: ''
solution:
  - Backlog بلا ترتيب معناه ما في PO فعّال — الترتيب مسؤوليته، والتنقية (refinement) شغل مستمر مع الفريق
  - Product Goal هدف طويل المدى، والـ Backlog كله لازم يخدمه
  ...
  - 'بنود اختبار نموذجية: حالات الاختبار منفّذة، اختبار انحدار للمسارات الحرجة، ما في Bugs مفتوحة بشدة عالية، وتغطية مصفوفة الأجهزة'
...
هذا الدرس بيغطّي **المخرجات الثلاثة الثلاثة** والالتزام المربوط بكل واحد. الشرح بالفيديو، وهذا ملخّص سريع.
...
قائمة **مرتّبة ومتغيّرة** بكل اللي محتاجه المنتج، وهي المصدر الوحيد للشغل. الـ PO مسؤول عن ترتيبها ووضوحها، و**التنقية (refinement)** شغل مستمر: تفصيل العناصر وتقديرها — والتقدير شغل الـ Developers. التزامها **Product Goal**: هدف طويل المدى يخدمه الـ Backlog كله.
...
- الـ Increment **تراكمي**: كل زيادة تُضاف للسابق وتتحقّق مع بعضها، وممكن يصير أكثر من Increment داخل الـ Sprint.
- **Definition of Done** هي الوصف الرسمي لحالة الجودة: شغل ما بيحقّقها **مش جزء من الـ Increment** — ما بينزل ولا بيُعرض بالـ Sprint Review، وبيرجع للBacklog.
- إذا الـ DoD معيار مؤسسي، فهي الحد الأدنى لكل الفرق.

## وين المختبر؟

الـ DoD هي مكان الاختبار بالإطار: «Done» يعني **مختبَر حسب الـ DoD** — فبنود الاختبار لازم تكون مكتوبة فيها ومتّفق عليها، مش اجتهاد بآخر الـ Sprint.
