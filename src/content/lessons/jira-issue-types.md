...
prerequisites:
  ...
  - فكرة عن الباكلوق والبورد من الدرس الأول
relatedLessons:
  - jira-first-project
  - jira-intro
...
exercise:
  ...
  - افتح الباكلوق وفلتر حسب النوع وشوف الصورة الكاملة
exerciseNote: ''
solution:
  ...
  - باق بلا خطوات إعادة إنتاج بيرجع لإلك Cannot Reproduce — الخطوات + الفعلي + المتوقّع هي الحد الأدنى
  - الـ Subtask بتتبع Issue واحد وما بتنتقل لوحدها بين السبرنتات
  - 'الفلترة حسب النوع بتكشف اختلال التوزيع: باكلوق كله Tasks يعني محدا بيفكّر بقيمة المستخدم'
solutionCode: ''
resources: []
featured: false
draft: false
...
انحراف عن السلوك المتوقّع. الحد الأدنى لأي باق: خطوات إعادة الإنتاج، النتيجة الفعلية، والنتيجة المتوقّعة.
